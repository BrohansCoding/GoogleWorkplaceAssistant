  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 bg-gray-800/60 backdrop-blur-sm">
      <div className="text-center max-w-md p-8 rounded-xl bg-gray-800/80 shadow-lg border border-gray-700">
        <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-amber-900 flex items-center justify-center">
          <Mail className="h-10 w-10 text-amber-400" />
        </div>
        <h2 className="text-2xl font-bold mb-4 text-amber-400">Email Coming Soon</h2>
        ...
        <div className="bg-gray-900/80 p-4 rounded-lg border border-amber-900">
          <h3 className="text-sm font-semibold text-amber-400 mb-2">What to expect:</h3>
